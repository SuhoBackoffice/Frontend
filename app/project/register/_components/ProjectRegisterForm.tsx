    ...
    <div className="mx-auto max-w-2xl py-8">
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold tracking-tight">새 프로젝트 등록</CardTitle>
          <CardDescription>프로젝트 정보를 입력하여 등록을 완료하세요.</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Popover open={comboboxOpen} onOpenChange={setComboboxOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className="bg-card w-full justify-between font-normal"
                  >
                    {versionId
                      ? versions.find((v) => v.id.toString() === versionId)?.name
                      : '예: v8.0'}
