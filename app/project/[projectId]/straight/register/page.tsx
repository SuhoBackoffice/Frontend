...
export default function StraightRailRegisterPage() {
  ...
  useEffect(() => {
    const fetchLoopType = async () => {
      try {
        ...
        toast.success(normalRes.message);
      } catch (err) {
                      ...
                      <TableRow key={row.id} className="divide-x">
                        ...
                        <TableCell>
                          <Input
                            ...
                            placeholder="예: 10"
                            onChange={(e) =>
                              handleRowChange(index, 'totalQuantity', e.target.value)
                            }
                        ...
                        <TableCell className="text-center">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleRowChange(index, 'isLoopRail', checked as boolean)
                            }
                          />
                        </TableCell>
                        <TableCell className="text-center">
